...
8. **Не успела сделать на текущий момент**. Все, что указано в этом пункте, актуально на тот момент, когда Вы это читаете. Я буду продолжать делать коммиты после сдачи анкеты, чтобы привести это приложение к законченному рабочему состоянию. Урок на будущее - тщательней планировать архитектуру приложения, причем до планирования верстки.
    ...
    * некорректно заполняется и сохраняется дата при создании встречи плюсиком
